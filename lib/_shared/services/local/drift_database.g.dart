...
class $TournamentsTable extends Tournaments
  ...
  static const VerificationMeta _hasStartedMeta = const VerificationMeta(
    'hasStarted',
  );
  @override
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('has_started')) {
      context.handle(
        _hasStartedMeta,
        hasStarted.isAcceptableOrUnknown(data['has_started']!, _hasStartedMeta),
      );
    }
  ...
  Tournament map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Tournament(
      ...
      hasStarted: attachedDatabase.typeMapping.read(
        DriftSqlType.bool,
        data['${effectivePrefix}has_started'],
      )!,
      hasFinished: attachedDatabase.typeMapping.read(
        DriftSqlType.bool,
...
class Tournament extends DataClass implements Insertable<Tournament> {
  ...
  Tournament copyWithCompanion(TournamentsCompanion data) {
    return Tournament(
      ...
      hasStarted: data.hasStarted.present
          ? data.hasStarted.value
          : this.hasStarted,
      hasFinished: data.hasFinished.present
          ? data.hasFinished.value
          : this.hasFinished,
...
class $PlayersTable extends Players with TableInfo<$PlayersTable, Player> {
  ...
  static const VerificationMeta _nationalRatingMeta = const VerificationMeta(
    'nationalRating',
  );
  @override
  ...
  late final GeneratedColumnWithTypeConverter<FideTitle, String> fideTitle =
      GeneratedColumn<String>(
        ...
        type: DriftSqlType.string,
        requiredDuringInsert: true,
      ).withConverter<FideTitle>($PlayersTable.$converterfideTitle);
  ...
  Player map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Player(
      ...
      gender: $PlayersTable.$convertergender.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.string,
          data['${effectivePrefix}gender'],
        )!,
      ),
      nationalRating: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}national_rating'],
      ),
      ...
      fideTitle: $PlayersTable.$converterfideTitle.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.string,
          data['${effectivePrefix}fide_title'],
        )!,
      ),
...
class Player extends DataClass implements Insertable<Player> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['year_of_birth'] = Variable<int>(yearOfBirth);
    {
      map['gender'] = Variable<String>(
        $PlayersTable.$convertergender.toSql(gender),
      );
    }
    ...
    }
    {
      map['fide_title'] = Variable<String>(
        $PlayersTable.$converterfideTitle.toSql(fideTitle),
      );
    }
  ...
  factory Player.fromJson(
    ...
    return Player(
      ...
      gender: $PlayersTable.$convertergender.fromJson(
      ...
      fideTitle: $PlayersTable.$converterfideTitle.fromJson(
        serializer.fromJson<String>(json['fideTitle']),
      ),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'gender': serializer.toJson<String>(
        $PlayersTable.$convertergender.toJson(gender),
      ),
      ...
      'fideTitle': serializer.toJson<String>(
        $PlayersTable.$converterfideTitle.toJson(fideTitle),
      ),
  ...
  Player copyWith({
    ...
    nationalRating: nationalRating.present
        ? nationalRating.value
        : this.nationalRating,
...
class PlayersCompanion extends UpdateCompanion<Player> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (gender.present) {
      map['gender'] = Variable<String>(
        $PlayersTable.$convertergender.toSql(gender.value),
      );
    }
    ...
    if (fideTitle.present) {
      map['fide_title'] = Variable<String>(
        $PlayersTable.$converterfideTitle.toSql(fideTitle.value),
      );
    }
    if (active.present) {
...
final class $$TournamentsTableReferences
  ...
  static MultiTypedResultKey<$PlayersTable, List<Player>> _playersRefsTable(
    ...
    db.players,
    aliasName: $_aliasNameGenerator(db.tournaments.id, db.players.tournamentId),
  );
