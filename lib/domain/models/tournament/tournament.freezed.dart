...
/// The unique identifier of the tournament.
 int? get id;/// The name of the tournament.
 String get name;/// The start date of the tournament.
 DateTime get startDate;/// The end date of the tournament.
 DateTime get endDate;/// The format of the tournament, like Swiss or Round Robin (not yet implemented).
 TournamentFormat get format;/// States if the tournament has already started.
 bool get hasStarted;/// States if the tournament is finished.
 bool get hasFinished;/// Archive status of the tournament
 bool get isArchived;
...
@override
int get hashCode => Object.hash(runtimeType,id,name,startDate,endDate,format,hasStarted,hasFinished,isArchived);
...
@useResult
$Res call({
 int? id, String name, DateTime startDate, DateTime endDate, TournamentFormat format, bool hasStarted, bool hasFinished, bool isArchived
});
...
/// Create a copy of Tournament
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? name = null,Object? startDate = null,Object? endDate = null,Object? format = null,Object? hasStarted = null,Object? hasFinished = null,Object? isArchived = null,}) {
...
as TournamentFormat,hasStarted: null == hasStarted ? _self.hasStarted : hasStarted // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  String name,  DateTime startDate,  DateTime endDate,  TournamentFormat format,  bool hasStarted,  bool hasFinished,  bool isArchived)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Tournament() when $default != null:
return $default(_that.id,_that.name,_that.startDate,_that.endDate,_that.format,_that.hasStarted,_that.hasFinished,_that.isArchived);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id,  String name,  DateTime startDate,  DateTime endDate,  TournamentFormat format,  bool hasStarted,  bool hasFinished,  bool isArchived)  $default,) {final _that = this;
switch (_that) {
case _Tournament():
return $default(_that.id,_that.name,_that.startDate,_that.endDate,_that.format,_that.hasStarted,_that.hasFinished,_that.isArchived);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id,  String name,  DateTime startDate,  DateTime endDate,  TournamentFormat format,  bool hasStarted,  bool hasFinished,  bool isArchived)?  $default,) {final _that = this;
switch (_that) {
case _Tournament() when $default != null:
return $default(_that.id,_that.name,_that.startDate,_that.endDate,_that.format,_that.hasStarted,_that.hasFinished,_that.isArchived);case _:
  return null;
...
class _Tournament implements Tournament {
  const _Tournament({this.id, required this.name, required this.startDate, required this.endDate, required this.format, required this.hasStarted, required this.hasFinished, required this.isArchived});
...
/// Create a copy of Tournament
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? name = null,Object? startDate = null,Object? endDate = null,Object? format = null,Object? hasStarted = null,Object? hasFinished = null,Object? isArchived = null,}) {
